...
<div id="cari-peraturan" class="px-4 sm:px-6 py-6 max-w-5xl mx-auto w-full">
    <div class="border border-gray-200 rounded-xl overflow-hidden">
        ...
        {{-- Filter --}}
        <div class="flex flex-col md:flex-row md:items-center gap-3 md:gap-0 px-4 py-3">
            ...
            {{-- Divider --}}
            <div class="hidden md:block w-px h-5 bg-gray-100 shrink-0 mx-2"></div>
            <div class="block md:hidden h-px bg-gray-100"></div>
            ...
            <button wire:click="resetFilter"
                class="flex items-center justify-center md:justify-start gap-1.5 text-xs text-gray-500 hover:text-red-500 hover:cursor-pointer transition-colors duration-150">
